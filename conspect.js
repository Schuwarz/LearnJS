...
// var не имеют блочной области видимости, они ограничены, как минимум, телом функции
if (true) {
  var test = true;
}
alert(test); // true
...
// Объявления var производится в начале исполнения функции
function sayHi() {
  phrase = "Привет";
  if (false) {
    var phrase;
...
sayHi();
// hoisting - поднятие, всплытие в самый верх функции

// var объявляется в начале, до присвоения с undefind
function sayHi() {
  alert(phrase);
  var phrase = "Привет";
}
